...
import projectEvaluationLearnerRoutes from './routes/project-evaluation-learner.routes';
...
app.use('/api/v1/project-evaluations/learner', projectEvaluationLearnerRoutes);
