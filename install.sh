...
echo "   psql -d learnlytica -f backend/migrations/010_seed_phase1_project_flow_templates.sql"
echo "   psql -d learnlytica -f backend/migrations/011_project_assessment_publish_and_assignment_workflow.sql"
echo "   psql -d learnlytica -f backend/migrations/012_reset_demo_auth_users.sql"
